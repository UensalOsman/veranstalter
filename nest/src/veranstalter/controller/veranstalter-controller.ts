...
import {
    VeranstalterMitDetailsUndDokumenten,
    type VeranstalterMitName,
    VeranstalterService,
} from '../service/veranstalter-service.js';
import { createPage, Page } from './page.js';

/**
 * Klasse für `VeranstalterQuery`, um Queries in _OpenAPI_ bzw. Swagger zu
 * formulieren.
 */
...
export class VeranstalterController {
    ...
    async getById(
        ...
        @Res() res: Response,
    ): Promise<Response<VeranstalterMitDetailsUndDokumenten>> {
        ...
        if (this.#logger.isLevelEnabled('debug')) {
            this.#logger.debug(
                'getById(): veranstalter=%s',
                veranstalter.toString(),
            );
            this.#logger.debug(
                'getById(): name=%s',
                JSON.stringify(veranstalter.name),
            );
        }
    ...
    async get(
        ...
        @Req() req: Request,
        @Res() res: Response,
    ): Promise<Response<Page<Readonly<VeranstalterMitName>> | CountResult>> {
        ...
        this.#logger.debug('get: veranstalterPage=%o', veranstalterPage);
    ...
    async getFileById(
        ...
        this.#logger.debug('getFileById: veranstalterId:%s', idStr);
